...
public class ProfileActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tab.setTabListener(new TabListener<ProfileFragment>(this,
				Config.PROFILE_FRAGMENT_TAG, ProfileFragment.class,
				Config.mainlayout));
		getSupportActionBar().addTab(tab);

		// Settings
		tab = getSupportActionBar().newTab().setText(R.string.tab_favorites);
		tab.setTabListener(new TabListener<FavoritesFragment>(this,
				Config.FAVORITES_FRAGMENT_TAG, FavoritesFragment.class,
				Config.mainlayout));
		getSupportActionBar().addTab(tab);
	...
	public void favoriteDeletionHandler(View target) {
		...
		if (textView != null) {
			...
			Toast.makeText(this, "Deleted " + favorite, Toast.LENGTH_SHORT)
					.show();
		}
	}
